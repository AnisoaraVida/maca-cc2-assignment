...
public class TypeVisitor extends VisitorImpl {

    public static final String SIZE = "Size ( BYTES )";
    public static final String NAME = "Content Type";
    public static final String NBFILES = "Nb files";
    ...
    public void visit(Component visitable) {
        try {
            ...
            cmdLineTable.addRow(visitable.getPath().toString(),
                    formatSize(translateSizeInUnit(size, sizeUnit.BYTES)));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void print() {
        ...
        cmdLineTable.addFinalRow(TOTAL + WS + unitStr,
                formatSize(translateSizeInUnit(totalSize, sizeUnit.BYTES)));
        cmdLineTable.print();
    }
